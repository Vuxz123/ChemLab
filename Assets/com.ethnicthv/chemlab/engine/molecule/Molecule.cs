...
namespace com.ethnicthv.chemlab.engine.molecule
{
    public class Molecule : IMutableMolecule
    {
        ...
        private HashSet<MoleculeTag> _tags = new();
        ...
        public class Builder
        {
            ...
            public Molecule Build()
            {
                ...
                // if ("novel".equals(_molecule.nameSpace))
                // {
                //     Molecule equivalentMolecule = _molecule.getEquivalent();
                ...
                //_molecule._structure.updateSideChainStructures();
                // if (!"novel".equals(_molecule.nameSpace))
                // {
                //     if (_molecule.id == null)
                //     {
                //         throw e("Molecule's ID has not been declared.");
                //     }
                //
                //     Molecule.MOLECULES.put(_molecule.nameSpace + ":" + _molecule.id, _molecule);
                // }
            ...
            public class MoleculeConstructionException : Exception
            {
                internal MoleculeConstructionException(string message) : base(message)
                {
                }


                internal MoleculeConstructionException(string message, Exception e) : base(message, e)
                {
                }
            }
        }
